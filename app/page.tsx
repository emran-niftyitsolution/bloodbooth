...
export default function Home() {
  ...
  const testimonials = [
    {
      ...
      quote:
        "Donating blood has been one of the most rewarding experiences. Knowing I can help save lives makes me feel incredible.",
      donations: 24,
    },
    {
      name: "Michael Chen",
      ...
      quote:
        "The process was so easy and the staff was amazing. I was nervous at first, but it was completely painless.",
      donations: 3,
    },
    {
      ...
      quote:
        "Organizing blood drives in our community has brought people together and saved countless lives. It's truly inspiring.",
      donations: 47,
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white relative">
        ...
        <div className="max-w-7xl mx-auto relative z-10 flex-1 flex items-center">
          <div className="grid lg:grid-cols-2 gap-16 items-center w-full py-12">
            ...
            >
              ...
              >
                Join thousands of heroes who donate blood regularly. Your single
                donation can save up to three lives. Be the reason someone
                smiles today.
              </motion.p>
              <motion.div
                variants={fadeInUp}
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-8">
              Local hospitals are experiencing a critical shortage. Your
              donation today could save a life in the next hour.
            </p>
      ...
      <section
        id="process"
        className="relative py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-gray-50 overflow-hidden"
      >
            ...
            {[
              {
                ...
                description:
                  "Quick 2-minute registration with your basic details and health information",
                icon: FaUserCheck,
                color: "#ef4444",
              },
              {
                ...
                description:
                  "Free comprehensive health check-up and blood type testing by professionals",
                icon: FaHeartbeat,
                color: "#ec4899",
              },
              {
                ...
                title: "Donate Blood",
                description:
                  "Safe 10-minute donation process with trained medical staff",
                icon: FaTint,
                color: "#f43f5e",
              },
              {
                ...
                title: "Rest & Refresh",
                description:
                  "Enjoy refreshments, receive your certificate and feel proud",
                icon: FaCheckCircle,
                color: "#fb7185",
              },
            ].map((item, index) => {
            ...
            {testimonials.map((testimonial, index) => (
              ...
              >
                <div className="relative h-full bg-white backdrop-blur-xl rounded-3xl border-2 border-gray-100 overflow-hidden shadow-lg hover:shadow-2xl transition-all p-8">
                  ...
                  <motion.div className="absolute top-0 left-0 right-0 h-2 bg-gradient-to-r from-red-500 to-pink-500 opacity-0 group-hover:opacity-100 transition-opacity" />
      ...
      <section
        id="benefits"
        className="py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 to-white"
      >
        <div className="max-w-7xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <p className="text-2xl text-white/95 mb-12 max-w-3xl mx-auto leading-relaxed">
              Join thousands of heroes making a difference. Your donation can
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                {["About Us", "Find Donor", "Blood Banks", "Campaigns"].map(
                  (link) => (
          ...
          <div className="border-t border-white/10 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="text-gray-400 text-center md:text-left">
                &copy; 2025 BloodBooth. All rights reserved. Saving lives, one
                donation at a time.
              </p>
